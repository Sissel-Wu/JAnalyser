...
public enum EInstruction
{
    ...
    lstore_0(0x3f), lstore_1(0x40), lsotre_2(0x41), lstore_3(0x42),
    ...
    ireturn(0xac), lreturn(0xad), freturn(0xae), dreturn(0xaf), areturn(0xb0), rreturn(0xb1),
    ...
    nnew(0xbb), newarray(0xbc), anewarray(0xbd),
    arraylength(0xbe),
    athrow(0xbf),
    checkcast(0xc0),
    iinstanceof(0xc1),
